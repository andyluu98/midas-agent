...
# (for index symbols like ^GSPC), and equals sign (for yfinance futures
# like GC=F, ZN=F). Anything else is rejected so the value never escapes
# a containing directory when interpolated into a path.
